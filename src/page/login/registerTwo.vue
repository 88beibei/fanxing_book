    ...
    <div class="register-content">
      ...
      <ul class="register-input">
        <li class="register-pwd">
          <input type="password" class="pwd" placeholder="请设置登录密码(支持8-20位数字字母)" v-model="passWord">
        </li>
        <li class="register-pwd">
          <input type="password" placeholder="请重复输入登录密码(支持8-20位数字字母)" v-model="repeatPassWord">
        </li>
      </ul>
